<nav>
  ...
  <main>
    <ul>
      ...
      <li><a href="#section-2" class="btn-sec">{{__('messages.nav-about')}}</a></li>
      <li><a href="#section-4" class="btn-sec">{{__('messages.nav-services')}}</a></li>
      <li><a href="#section-3" class="btn-sec">{{__('messages.nav-systems')}}</a></li>
    </ul>
