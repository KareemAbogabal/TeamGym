<nav>
  <div class="img-and-menu">
    <img src="{{asset("images/header/Team-Gym.png")}}" alt="No Img Logo" loading="lazy">
    <div class="menu">
  ...
  <div class="account-main">
    <button type="button" @if ($notifications->isNotEmpty() && $employee->setting->class_reminders == true) class="notification-btn there-is" @else class="notification-btn" @endif>
      ...
      @if ($notifications->isNotEmpty() && $employee->setting->class_reminders == true)
    ...
    <div class="notifications">
      ...
      <div class="notifications__list">
        @if ($employee->setting->class_reminders == true)
          @if ($notifications->isNotEmpty())
    ...
    <div class="account-icon">
      ...
      <div class="options">
        @if ($employee->job_role == "admin" && $settingCompany->add_employees == true)
          <button type="button" class="add-employee" data-follow="add-employee"><i class="fa-solid fa-user-plus"></i></button>
        @endif
      </div>
    </div>
  </div>
