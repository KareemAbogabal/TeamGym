...
@section('content')
  <x-components::main-card state="details-customer" dataFollow="details-card">
    <div class="body-card">
        ...
        <div class="button-row-card">
          <div class="buttons">
            <button type="button" class="close-profile" data-follow="details-card">{{__('messages.card-profile-button-close')}}</button>
          </div>
        </div>
      </div>
    </x-components::main-card>
  <button class="button-form" data-follow="records-form">{{__('messages.attendance-record')}}</button>
  <x-company::recordsForm
    ...
    :systems="$systems"
  />
  <div class="main-customer-subscriptions">
    ...
    <x-components::main-card state="entrances" dataFollow="entrances-card">
      <div class="body-card">
          ...
          <form action="{{route("recordExit")}}" method="post" class="exit-form">
            ...
            <div class="button-row-card">
              <div class="buttons">
                <button type="button" class="close-profile" data-follow="entrances-card">{{__('messages.card-profile-button-close')}}</button>
